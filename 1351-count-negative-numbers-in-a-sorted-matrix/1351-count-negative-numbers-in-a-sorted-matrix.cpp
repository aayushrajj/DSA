...
public:
    int countNegatives(vector<vector<int>>& grid) {
        ...
        //we will be using binary search to serch a negative number in every row
        //if we find the index of the neg number in ith row
        //then the index of negative number in the i+1 row must be before or on the same index of the previous row ,since colums are sorted in non increasing order
